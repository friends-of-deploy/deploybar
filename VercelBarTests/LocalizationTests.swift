...
final class LocalizationTests: XCTestCase {
    ...
    private func loadCatalog() throws -> [String: Any] {
        let testFile = URL(fileURLWithPath: #filePath)              // .../VercelBarTests/LocalizationTests.swift
        let repoRoot = testFile.deletingLastPathComponent()         // .../VercelBarTests
            .deletingLastPathComponent()                            // .../<repo root>
        let catalog = repoRoot
            .appendingPathComponent("VercelBar")
