...
We pledge to act and interact in ways that contribute to an open, inclusive, and
healthy community.
...
reported to the project maintainers at <MAINTAINER CONTACT EMAIL>.
<!-- Maintainer: replace the address above with a real contact before launch. -->
